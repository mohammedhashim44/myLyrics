...
from myLyrics.src.lyrics_repositories.lyrics_repository import LyricsRepository
...
class LyricsModeRepository(LyricsRepository):
    ...
    def search_song_in_website(self, searched_song_string) -> SearchResult:
        ...
        search_url = self.construct_search_url(searched_song_string)
